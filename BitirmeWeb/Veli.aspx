<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Veli.aspx.cs" Inherits="BitirmeWeb.Veli" EnableEventValidation="false" %>
...
<body id="page-top" class="index">
    ...
    <form id="form1" runat="server">
        ...
        <!-- Veli -->
        <asp:Panel runat="server" ID="veli_paneli">
            <section id="veli">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">VELİ</h2>
                        </div>
                    </div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b>
                                                                        <asp:Label Text="" ID="lblOgrTC" runat="server" />
                                                                    </b>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <div class="col-lg-6 col-lg-offset-3">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <br />
                                                            <asp:TextBox runat="server" ID="txtAyarOgrTC" Enabled="false" CssClass="form-control" placeholder="Öğrenci No" />
                                                            <br />
                                                            <asp:TextBox runat="server" ID="txtAyarEposta" CssClass="form-control" placeholder="E-posta" />
                                                            <asp:RequiredFieldValidator ErrorMessage="Bu Alan Boş Geçilemez!" ControlToValidate="txtAyarEposta" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="Red" ValidationGroup="veliAyar" />
                                                            <br />
                                                            <asp:TextBox runat="server" ID="txtAyarParola" TextMode="Password" CssClass="form-control" placeholder="Parola" />
                                                            <asp:RequiredFieldValidator ErrorMessage="Bu Alan Boş Geçilemez!" ControlToValidate="txtAyarParola" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="Red" ValidationGroup="veliAyar" />
                                                            <br />
                                                            <asp:TextBox runat="server" ID="txtAyarParolaTekrar" TextMode="Password" CssClass="form-control" placeholder="Parola (Tekrar)" />
                                                            <asp:RequiredFieldValidator ErrorMessage="Bu Alan Boş Geçilemez!" ControlToValidate="txtAyarParolaTekrar" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="Red" ValidationGroup="veliAyar" />
                                                            <br />
                                                            <asp:Button Text="GÜNCELLE" runat="server" OnClick="btnGuncelle_Click" ID="btnGuncelle" CssClass="btn btn-xl btn-lg btn-primary btn-block" ValidationGroup="veliAyar" />
                                                            <br />
